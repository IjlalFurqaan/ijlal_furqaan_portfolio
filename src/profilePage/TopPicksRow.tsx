...
const topPicksConfig = {
  ...
  stalker: [
    ...
    { title: "GitHub", imgSrc: "https://picsum.photos/seed/codehub/250/200", route: "/github", icon: <FaGithub /> },
  ...
  adventurer: [
    ...
    { title: "GitHub", imgSrc: "https://picsum.photos/seed/explore/250/200", route: "/github", icon: <FaGithub /> },
    { title: "Skills", imgSrc: "https://picsum.photos/seed/talent/250/200", route: "/skills", icon: <FaCode /> },
    { title: "Experience", imgSrc: "https://picsum.photos/seed/journey/250/200", route: "/work-experience", icon: <FaBriefcase /> },
    { title: "Contact Me", imgSrc: "https://picsum.photos/seed/connect/250/200", route: "/contact-me", icon: <FaEnvelope /> }
  ]
};
